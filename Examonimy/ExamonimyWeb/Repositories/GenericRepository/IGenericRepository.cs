...
namespace ExamonimyWeb.Repositories.GenericRepository
{
    ...
    {
        Task<PagedList<TEntity>> GetPagedListAsync(RequestParams? requestParams, Expression<Func<TEntity, bool>>? searchPredicate, Expression<Func<TEntity, bool>>? filterPredicate, List<string>? includedProperties, Func<IQueryable<TEntity>, IOrderedQueryable<TEntity>>? orderByPredicate = null);
