...
export const showSpinnerForButton = (buttonTextElement = new HTMLElement(), button = new HTMLButtonElement(), spinnerOption = new SpinnerOption()) => {
...
export const hideSpinnerForButton = (button = new HTMLButtonElement(), buttonTextElement = new HTMLElement(), spinnerOption = new SpinnerOption()) => {
