...
postButton.addEventListener("click", async () => {
    ...
    examCreate.from = constructExamSchedule(fromHourInput.value, fromMinuteInput.value, fromDateInput.value);
    examCreate.to = constructExamSchedule(toHourInput.value, toMinuteInput.value, toDateInput.value);
