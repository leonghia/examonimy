...
export class QuestionListPaletteComponent extends BaseComponent {
    ...
    #renderQuestions() {
        return this.#questions.reduce((accumulator, currentValue) => {
            return accumulator + `
<!-- Active: "bg-gray-200" -->
<li data-question-id="${currentValue.id}" class="group flex items-center select-none rounded-xl p-3 hover:bg-gray-200 cursor-pointer">
    ...
    <div class="ml-4 flex-auto">
        ...
        <p class="text-sm font-medium text-violet-700 mb-1">${currentValue.questionContent}</p>
...
<div class="mt-8 mx-auto transform divide-y divide-gray-100 overflow-hidden rounded-lg bg-white transition-all">
    ...
    <ul class="max-h-96 scroll-py-3 overflow-y-auto p-3 divide-y divide-gray-100">
        ${questionListMarkup}
    </ul>
