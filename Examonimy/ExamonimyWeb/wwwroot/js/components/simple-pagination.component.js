...
export class SimplePaginationComponent extends BaseComponent {
    ...
    #render() {
        return `
<div class="flex items-center justify-between w-full text-gray-800 dark:text-gray-400 bg-gray-200 rounded-lg dark:bg-gray-600 max-w-fit">
    <button id="prev-btn" type="button" class="inline-flex items-center justify-center h-8 px-1 w-6 bg-gray-200 rounded-s-lg dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-800 focus:outline-none focus:ring-0 focus:ring-gray-200 dark:focus:ring-gray-800">
    ...
    <button id="next-btn" type="button" class="inline-flex items-center justify-center h-8 px-1 w-6 bg-gray-200 rounded-e-lg dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-800 focus:outline-none focus:ring-0 focus:ring-gray-200 dark:focus:ring-gray-800">
        <svg class="w-2 h-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
