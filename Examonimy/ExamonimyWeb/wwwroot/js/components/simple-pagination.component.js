...
export class SimplePaginationComponent extends BaseComponent {
    ...
    populatePaginationInfo(totalPages) {       
        ...
        this.#paginationInfo.textContent = `Trang ${this.#currentPage} trên ${this.#totalPages}`;
    }

    #render() {
        return `
<div class="flex items-center justify-between w-full text-gray-600 dark:text-gray-400 bg-gray-100 rounded-lg dark:bg-gray-600 max-w-fit mx-2">
